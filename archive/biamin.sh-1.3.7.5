...
$CC"  > "$GAMEDIR/LICENSE"
	...
	echo "Can't download licenses :( Do you have Internet access?"
	sleep 1
	return 1
    fi
}
...
License() { # Used in Credits()
	...
	less "$GAMEDIR/LICENSE" # TODO $PAGER was unset/didn't work..? Staying with less atm..
    else
	...
	case "$DL_LICENSE_OPT" in
	    YES ) 
		PrepareLicense && less "$GAMEDIR/LICENSE" ;;
	    * ) 
		echo -e "
